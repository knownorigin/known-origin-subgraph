...
export class TokenMarketplace extends ethereum.SmartContract {
  ...
  try_defaultKOPercentage(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "defaultKOPercentage",
      "defaultKOPercentage():(uint256)",
      []
  ...
  defaultArtistRoyaltyPercentage(): BigInt {
    let result = super.call(
      "defaultArtistRoyaltyPercentage",
      "defaultArtistRoyaltyPercentage():(uint256)",
      []
    );
  ...
  try_defaultArtistRoyaltyPercentage(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "defaultArtistRoyaltyPercentage",
      "defaultArtistRoyaltyPercentage():(uint256)",
      []
  ...
  try_tokenOffer(
    _tokenId: BigInt
  ): ethereum.CallResult<TokenMarketplace__tokenOfferResult> {
    let result = super.tryCall(
      "tokenOffer",
      "tokenOffer(uint256):(address,uint256,address,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(_tokenId)]
