...
export class ArtistAcceptingBidsV2 extends ethereum.SmartContract {
  ...
  editionHighestBid(param0: BigInt): Address {
    let result = super.call(
      "editionHighestBid",
      "editionHighestBid(uint256):(address)",
  ...
  try_editionHighestBid(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "editionHighestBid",
      "editionHighestBid(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  editionsOnceEnabledForAuctions(param0: BigInt): BigInt {
    let result = super.call(
      "editionsOnceEnabledForAuctions",
      "editionsOnceEnabledForAuctions(uint256):(uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try_editionsOnceEnabledForAuctions(
    param0: BigInt
  ...
  editionNumberToArtistControlAddress(param0: BigInt): Address {
    let result = super.call(
      "editionNumberToArtistControlAddress",
      "editionNumberToArtistControlAddress(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );
  ...
  try_editionNumberToArtistControlAddress(
    param0: BigInt
  ...
  try_enabledEditions(param0: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "enabledEditions",
      "enabledEditions(uint256):(bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  rejectBid(_editionNumber: BigInt): boolean {
    let result = super.call("rejectBid", "rejectBid(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_rejectBid(_editionNumber: BigInt): ethereum.CallResult<boolean> {
    let result = super.tryCall("rejectBid", "rejectBid(uint256):(bool)", [
      ethereum.Value.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  enableEditionForArtist(_editionNumber: BigInt): boolean {
    let result = super.call(
      "enableEditionForArtist",
      "enableEditionForArtist(uint256):(bool)",
      [ethereum.Value.fromUnsignedBigInt(_editionNumber)]
    );
  ...
  try_auctionDetails(
    _editionNumber: BigInt
  ): ethereum.CallResult<ArtistAcceptingBidsV2__auctionDetailsResult> {
    let result = super.tryCall(
      "auctionDetails",
      "auctionDetails(uint256):(bool,address,uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(_editionNumber)]
  ...
  try_highestBidForEdition(
    _editionNumber: BigInt
  ): ethereum.CallResult<ArtistAcceptingBidsV2__highestBidForEditionResult> {
    let result = super.tryCall(
      "highestBidForEdition",
      "highestBidForEdition(uint256):(address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_editionNumber)]
  ...
  addedEditions(): Array<BigInt> {
    let result = super.call("addedEditions", "addedEditions():(uint256[])", []);

    return result[0].toBigIntArray();
  }

  try_addedEditions(): ethereum.CallResult<Array<BigInt>> {
    let result = super.tryCall(
      "addedEditions",
      "addedEditions():(uint256[])",
      []
    );
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class EnableEditionForArtistCall extends ethereum.Call {
