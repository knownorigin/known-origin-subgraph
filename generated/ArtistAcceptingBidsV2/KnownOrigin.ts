...
export class Purchase extends EthereumEvent {
...
export class EditionCreated extends EthereumEvent {
...
export class KnownOrigin extends SmartContract {
  ...
  priceInWeiToken(_tokenId: BigInt): BigInt {
    let result = super.call("priceInWeiToken", [
      EthereumValue.fromUnsignedBigInt(_tokenId)
    ]);
  ...
  try_priceInWeiToken(_tokenId: BigInt): CallResult<BigInt> {
    let result = super.tryCall("priceInWeiToken", [
      EthereumValue.fromUnsignedBigInt(_tokenId)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  editionData(_editionNumber: BigInt): Bytes {
    let result = super.call("editionData", [
  ...
  try_editionData(_editionNumber: BigInt): CallResult<Bytes> {
    let result = super.tryCall("editionData", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  tokenURIEdition(_editionNumber: BigInt): string {
    let result = super.call("tokenURIEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_tokenURIEdition(_editionNumber: BigInt): CallResult<string> {
    let result = super.tryCall("tokenURIEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  try_mint(_to: Address, _editionNumber: BigInt): CallResult<BigInt> {
  ...
  totalNumberAvailable(): BigInt {
    let result = super.call("totalNumberAvailable", []);

    return result[0].toBigInt();
  }

  try_totalNumberAvailable(): CallResult<BigInt> {
    let result = super.tryCall("totalNumberAvailable", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  priceInWeiEdition(_editionNumber: BigInt): BigInt {
    let result = super.call("priceInWeiEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_priceInWeiEdition(_editionNumber: BigInt): CallResult<BigInt> {
    let result = super.tryCall("priceInWeiEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  tokenBaseURI(): string {
    let result = super.call("tokenBaseURI", []);

    return result[0].toString();
  }

  try_tokenBaseURI(): CallResult<string> {
    let result = super.tryCall("tokenBaseURI", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  editionType(_editionNumber: BigInt): BigInt {
    let result = super.call("editionType", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_editionType(_editionNumber: BigInt): CallResult<BigInt> {
    let result = super.tryCall("editionType", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  artistsEditions(_artistsAccount: Address): Array<BigInt> {
    let result = super.call("artistsEditions", [
      EthereumValue.fromAddress(_artistsAccount)
    ]);

    return result[0].toBigIntArray();
  }

  try_artistsEditions(_artistsAccount: Address): CallResult<Array<BigInt>> {
    let result = super.tryCall("artistsEditions", [
      EthereumValue.fromAddress(_artistsAccount)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  totalAvailableEdition(_editionNumber: BigInt): BigInt {
    let result = super.call("totalAvailableEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_totalAvailableEdition(_editionNumber: BigInt): CallResult<BigInt> {
    let result = super.tryCall("totalAvailableEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  tokensOfEdition(_editionNumber: BigInt): Array<BigInt> {
    let result = super.call("tokensOfEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_tokensOfEdition(_editionNumber: BigInt): CallResult<Array<BigInt>> {
    let result = super.tryCall("tokensOfEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  underMint(_to: Address, _editionNumber: BigInt): BigInt {
    let result = super.call("underMint", [
      EthereumValue.fromAddress(_to),
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_underMint(_to: Address, _editionNumber: BigInt): CallResult<BigInt> {
    let result = super.tryCall("underMint", [
      EthereumValue.fromAddress(_to),
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
  ...
  editionOfTokenId(_tokenId: BigInt): BigInt {
    let result = super.call("editionOfTokenId", [
      EthereumValue.fromUnsignedBigInt(_tokenId)
    ]);
  ...
  try_editionOfTokenId(_tokenId: BigInt): CallResult<BigInt> {
    let result = super.tryCall("editionOfTokenId", [
      EthereumValue.fromUnsignedBigInt(_tokenId)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  createActiveEdition(
    ...
    let result = super.call("createActiveEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber),
      EthereumValue.fromFixedBytes(_editionData),
      EthereumValue.fromUnsignedBigInt(_editionType),
      EthereumValue.fromUnsignedBigInt(_startDate),
      EthereumValue.fromUnsignedBigInt(_endDate),
      EthereumValue.fromAddress(_artistAccount),
      EthereumValue.fromUnsignedBigInt(_artistCommission),
      EthereumValue.fromUnsignedBigInt(_priceInWei),
      EthereumValue.fromString(_tokenURI),
      EthereumValue.fromUnsignedBigInt(_totalAvailable)
    ]);
  ...
  try_createActiveEdition(
    ...
    let result = super.tryCall("createActiveEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber),
      EthereumValue.fromFixedBytes(_editionData),
      EthereumValue.fromUnsignedBigInt(_editionType),
      EthereumValue.fromUnsignedBigInt(_startDate),
  ...
  ROLE_MINTER(): i32 {
    let result = super.call("ROLE_MINTER", []);

    return result[0].toI32();
  }

  try_ROLE_MINTER(): CallResult<i32> {
    let result = super.tryCall("ROLE_MINTER", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  ROLE_UNDER_MINTER(): i32 {
    let result = super.call("ROLE_UNDER_MINTER", []);

    return result[0].toI32();
  }

  try_ROLE_UNDER_MINTER(): CallResult<i32> {
    let result = super.tryCall("ROLE_UNDER_MINTER", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  createInactivePreMintedEdition(
    ...
    let result = super.call("createInactivePreMintedEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber),
      EthereumValue.fromFixedBytes(_editionData),
      EthereumValue.fromUnsignedBigInt(_editionType),
      EthereumValue.fromUnsignedBigInt(_startDate),
  ...
  try_createInactivePreMintedEdition(
    ...
    let result = super.tryCall("createInactivePreMintedEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber),
      EthereumValue.fromFixedBytes(_editionData),
      EthereumValue.fromUnsignedBigInt(_editionType),
      EthereumValue.fromUnsignedBigInt(_startDate),
  ...
  highestEditionNumber(): BigInt {
    let result = super.call("highestEditionNumber", []);

    return result[0].toBigInt();
  }

  try_highestEditionNumber(): CallResult<BigInt> {
    let result = super.tryCall("highestEditionNumber", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  createActivePreMintedEdition(
    ...
    let result = super.call("createActivePreMintedEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber),
      EthereumValue.fromFixedBytes(_editionData),
      EthereumValue.fromUnsignedBigInt(_editionType),
      EthereumValue.fromUnsignedBigInt(_startDate),
  ...
  try_createActivePreMintedEdition(
    ...
    let result = super.tryCall("createActivePreMintedEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber),
      EthereumValue.fromFixedBytes(_editionData),
      EthereumValue.fromUnsignedBigInt(_editionType),
      EthereumValue.fromUnsignedBigInt(_startDate),
  ...
  totalSupplyEdition(_editionNumber: BigInt): BigInt {
    let result = super.call("totalSupplyEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_totalSupplyEdition(_editionNumber: BigInt): CallResult<BigInt> {
    let result = super.tryCall("totalSupplyEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  editionActive(_editionNumber: BigInt): boolean {
    let result = super.call("editionActive", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_editionActive(_editionNumber: BigInt): CallResult<boolean> {
    let result = super.tryCall("editionActive", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  totalRemaining(_editionNumber: BigInt): BigInt {
    let result = super.call("totalRemaining", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_totalRemaining(_editionNumber: BigInt): CallResult<BigInt> {
    let result = super.tryCall("totalRemaining", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  ROLE_KNOWN_ORIGIN(): i32 {
    let result = super.call("ROLE_KNOWN_ORIGIN", []);

    return result[0].toI32();
  }

  try_ROLE_KNOWN_ORIGIN(): CallResult<i32> {
    let result = super.tryCall("ROLE_KNOWN_ORIGIN", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  editionExists(_editionNumber: BigInt): boolean {
    let result = super.call("editionExists", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
  ...
  try_editionExists(_editionNumber: BigInt): CallResult<boolean> {
    let result = super.tryCall("editionExists", [
      EthereumValue.fromUnsignedBigInt(_editionNumber)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  createInactiveEdition(
    ...
    let result = super.call("createInactiveEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber),
      EthereumValue.fromFixedBytes(_editionData),
      EthereumValue.fromUnsignedBigInt(_editionType),
      EthereumValue.fromUnsignedBigInt(_startDate),
  ...
  try_createInactiveEdition(
    ...
    let result = super.tryCall("createInactiveEdition", [
      EthereumValue.fromUnsignedBigInt(_editionNumber),
      EthereumValue.fromFixedBytes(_editionData),
      EthereumValue.fromUnsignedBigInt(_editionType),
      EthereumValue.fromUnsignedBigInt(_startDate),
  ...
  editionsOfType(_type: BigInt): Array<BigInt> {
    let result = super.call("editionsOfType", [
      EthereumValue.fromUnsignedBigInt(_type)
    ]);

    return result[0].toBigIntArray();
  }

  try_editionsOfType(_type: BigInt): CallResult<Array<BigInt>> {
    let result = super.tryCall("editionsOfType", [
      EthereumValue.fromUnsignedBigInt(_type)
    ]);
    if (result.reverted) {
      return new CallResult();
  ...
  totalNumberMinted(): BigInt {
    let result = super.call("totalNumberMinted", []);

    return result[0].toBigInt();
  }

  try_totalNumberMinted(): CallResult<BigInt> {
    let result = super.tryCall("totalNumberMinted", []);
    if (result.reverted) {
      return new CallResult();
    }
    let value = result.value;
  ...
  tokenURISafe(_tokenId: BigInt): string {
    let result = super.call("tokenURISafe", [
      EthereumValue.fromUnsignedBigInt(_tokenId)
    ]);
  ...
  try_tokenURISafe(_tokenId: BigInt): CallResult<string> {
    let result = super.tryCall("tokenURISafe", [
      EthereumValue.fromUnsignedBigInt(_tokenId)
    ]);
    if (result.reverted) {
      return new CallResult();
...
export class UpdateActiveCall extends EthereumCall {
...
export class UpdateKoCommissionAccountCall extends EthereumCall {
...
export class UpdateTokenBaseURICall extends EthereumCall {
...
export class UpdateStartDateCall extends EthereumCall {
...
export class AddAddressToAccessControlCall extends EthereumCall {
...
export class UpdateArtistCommissionCall extends EthereumCall {
...
export class UpdateEditionTokenURICall extends EthereumCall {
...
export class UnderMintCall extends EthereumCall {
...
export class UpdatePriceInWeiCall extends EthereumCall {
...
export class PurchaseToCall extends EthereumCall {
...
export class CreateActiveEditionCall extends EthereumCall {
...
export class RemoveAddressFromAccessControlCall extends EthereumCall {
...
export class UpdateOptionalCommissionCall extends EthereumCall {
...
export class CreateInactivePreMintedEditionCall extends EthereumCall {
...
export class BatchTransferCall extends EthereumCall {
...
export class CreateActivePreMintedEditionCall extends EthereumCall {
...
export class UpdateArtistsAccountCall extends EthereumCall {
...
export class UpdateTotalAvailableCall extends EthereumCall {
...
export class UpdateEditionTypeCall extends EthereumCall {
...
export class UpdateEndDateCall extends EthereumCall {
...
export class CreateInactiveEditionCall extends EthereumCall {
...
export class PurchaseCall extends EthereumCall {
...
export class UpdateTotalSupplyCall extends EthereumCall {
