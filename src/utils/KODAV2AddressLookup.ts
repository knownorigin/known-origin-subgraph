...
export const KODA_V2_MAINNET_SECONDARY_MARKETPLACE = "0xc322cdd03f34b6d25633c2abbc8716a058c7fe9e";
export const KODA_V2_RINKEBY_SECONDARY_MARKETPLACE = "0xdAc14EA324560DdC4d0722D8E7636F852697FB69";
...
export function getKnownOriginV2ForAddress(address: Address): KnownOriginV2 {
    ...
    mainnetAddresses.push(Address.fromString(KODA_V2_MAINNET_SECONDARY_MARKETPLACE)) // token marketplace V2
